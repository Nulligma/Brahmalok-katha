...
export const TRANSLATIONS: Record<Language, TranslationBundle> = {
  en: {
    ...
    footerText: "product of nadistuti.com",
    you: "YOU",
  ...
  hi: {
    ...
    footerText: "nadistuti.com का उत्पाद",
    you: "आप",
  ...
  mr: {
    ...
    footerText: "nadistuti.com चे उत्पादन",
    you: "तुम्ही",
  ...
  kn: {
    ...
    footerText: "nadistuti.com ನ ಉತ್ಪನ್ನ",
    you: "ನೀವು",
  ...
  ta: {
    ...
    footerText: "nadistuti.com இன் தயாரிப்பு",
    you: "நீங்கள்",
  ...
  ml: {
    ...
    footerText: "nadistuti.com-ന്റെ ഉൽപ്പന്നം",
    you: "നിങ്ങൾ",
